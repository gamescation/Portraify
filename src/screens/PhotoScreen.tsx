  ...
  return (
    <View style={styles.container}>
        ...
        <View style={[styles.disclaimerWrap, { top: (dimensions.screenHeight * 8) / 10, width: dimensions.screenWidth }]}>
          <Txt size={Size.S} style={[styles.disclaimer]}>Generated faces and images are may not look like the face the original image. All images are provided "as-is" solely for entertainment purposes.</Txt>
        </View>
    </View>
  );
};
